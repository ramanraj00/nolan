    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col font-sans">
      ...
      <header className="border-b border-white/10 p-6 flex justify-between items-center">
        <div className="text-xl font-black tracking-tight flex items-center">
          Nolan <span className="text-[#888] ml-2 font-normal text-sm">Store Demo</span>
        </div>
        <a href="/dashboard" className="text-xs font-bold uppercase tracking-widest text-[#32ADE6] hover:text-white transition-colors">Go to Dashboard &rarr;</a>
      </header>

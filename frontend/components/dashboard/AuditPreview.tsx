...
export default function AuditPreview({ data }: { data: ActionData }) {
  ...
  return (
    <div className="bg-[#111217] rounded-2xl border border-white/10 shadow-[0_0_20px_rgba(200,255,0,0.05)] h-full p-4 flex flex-col justify-start relative overflow-hidden">
      <div className="absolute top-0 right-0 w-24 h-24 bg-[#FF9500]/5 rounded-full blur-[30px] pointer-events-none"></div>
      <h3 className="text-zinc-400 font-bold text-[10px] tracking-widest uppercase mb-2">Action Health</h3>
